    ...
    _createClass(ValidatedInput, [{
        ...
        value: function inputProps() {
            var _props = this.props,
                validationEvent = _props.validationEvent,
                validate = _props.validate,
                errorHelp = _props.errorHelp,
                _registerInput = _props._registerInput,
                _unregisterInput = _props._unregisterInput,
                label = _props.label,
                inputProps = _objectWithoutProperties(_props, ['validationEvent', 'validate', 'errorHelp', '_registerInput', '_unregisterInput', 'label']);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { validationState: this.props.help ? 'error' : null },
